...
<template>
  <Dialog v-model:visible="itemStore.dialogStatus" modal :header="itemStore.currentItem?.itemName" :style="{ width: '50rem' }" :breakpoints="{ '1199px': '75vw', '575px': '90vw' }">
    <div class="p-3" style="text-align: center">
      ...
      <div style="font-size: 24px; font-weight: bold; margin-bottom: -10px;">
        {{ itemStore.currentItem?.itemName }}
      </div>
        ...
        <TabPanels>
          <TabPanel value="0">
            <div class="grid grid-cols-3 gap-4">
              <div class="..." v-for="ingredient in itemStore.currentItem?.customize">
